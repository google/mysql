...
static SYMBOL symbols[] = {
  ...
  { "BINLOG_GROUP_ID",	SYM(BINLOG_GROUP_ID_SYM)},
  { "BIT",		SYM(BIT_SYM)},
  { "BLOB",		SYM(BLOB_SYM)},
  { "BLOCK",  SYM(BLOCK_SYM)},
  { "BOOL",		SYM(BOOL_SYM)},
  ...
  { "CONNECT_USING_GROUP_ID", SYM(CONNECT_USING_GROUP_ID_SYM)},
  ...
  { "GOOGLESTATS",      SYM(GOOGLESTATS_SYM)},
  { "GRANT",		SYM(GRANT)},
  { "GRANTS",	        SYM(GRANTS)},
  { "GROUP",		SYM(GROUP_SYM)},
  ...
  { "STATS_SERVER",     SYM(STATS_SERVER_SYM)},
  { "STATS_SERVERS",    SYM(STATS_SERVERS_SYM)},
