...
ALTER TABLE user MODIFY plugin char(64) CHARACTER SET latin1 DEFAULT '' NOT NULL, MODIFY authentication_string TEXT NULL;
...
ALTER TABLE system_user MODIFY authentication_string TEXT NULL;
...
ALTER TABLE proxies_priv ENGINE=InnoDB;
